...
int MagicNumber = 316;             // change this if you are re-compiling and you dont want to use the ESPROM settings
...
int  capture_interval = 40;       //  milli-seconds between frames
volatile int  total_frames_config = 250;  //  how many frames - length of movie in ms is total_frames x capture_interval
